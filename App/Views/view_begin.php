...
<head>
	<meta charset="utf-8" />
	<title>Plateforme Streaming</title>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item mx-2">
						<a class="nav-link text-white" href="index.php?action=Rapprochement_de_Film">Rapprochement de Film</a>
					</li>
					<li class="nav-item mx-2">
						<a class="nav-link text-white" href="index.php?action=Films_acteurs_communs ">Films / acteurs communs </a>
					</li>
				</ul>
			</div>
			...
			<div>
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link d-flex align-items-center justify-content-center text-white" href="index.php?action=recherche">
