			...
			<div class="d-flex ms-auto">
				<?php if (isset($_SESSION['user'])) : ?>
					<ul class="navbar-nav me-3">
						<li class="nav-item">
							<a class="nav-link d-flex align-items-center justify-content-center text-white mt-1" href="index.php?controller=Search">
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="transform: translateX(-50%);">
							<?php
							if (isset($_SESSION['user'])) {
								echo '<li><a class="dropdown-item" href="index.php?controller=Profil">Profil</a></li>';
								echo '<li><a class="dropdown-item" href="index.php?controller=Connexion&action=signOut">Déconnexion</a></li>';
							} else {
								echo '<li><a class="dropdown-item" href="index.php?controller=Connexion&action=signInForm">Connexion</a></li>';
								echo '<li><a class="dropdown-item" href="index.php?controller=Connexion">Inscription</a></li>';
							}
							?>
						</ul>
					</li>
